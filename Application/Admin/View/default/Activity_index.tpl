    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-bordered" id="addForm" method="post"
                  action="{:$smarty.const.__MODULE__}/activity/activityAdd">
                <div class="input-holder">
                    ...
                    {:foreach $list as $item}
                        <div class="row" data-id="{:$item['id']}">
                                    ...
                                    <div class="col-md-11 ke_image_upload">
                                        <div class="input-group">
                                            <input type="text" class="video_url ke_image_upload_input form-control"
                                                   ...
                                                   name="activity[{:$item@iteration}][pic]"
                                                   value="{:$item['pic']}"/>
                                    ...
                                    <div class="col-md-11 ke_image_upload">
                                        <div class="input-group">
                                            <input type="text" class="video_url ke_image_upload_input form-control"
                                                   ...
                                                   placeholder="内容图"
                                                   data-msg-required="分享图片不能为空"
                                                   name="activity[{:$item@iteration}][url]"
                                                   value="{:$item['url']}"/>
                                            <span class="input-group-btn">
                                                <button type="button" class="js-btn_qiniu_upload qiniu btn btn-default">上传</button>
                                            </span>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <input type="text" placeholder="优先级" value="{:$item['rank']}" name="activity[{:$item@iteration}][rank]" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-default btn-delete" style="margin-top: 16px;">删除
                                </button>
                            </div>
                        </div>
                    {:/foreach}
        ...
        $(document).ready(function () {
            $('.btn-add').on('click', function () {
                ...
                $('.input-holder').append(
                    ...
                    '<div class="form-group">'+
                    '<input type="text" placeholder="优先级" value="100" name="activity[' + count + '][rank]" class="form-control">'+
                    '</div>'+
                    '</div>'+
                    '<div class="col-sm-2">' +
                    '<button type="button" class="btn btn-default btn-delete" style="margin-top: 16px;">删除' +
...
//                name="activity[' + count + '][url]"
            ...
            $('#confirm_btn_certain').on('click', function () {
                var id = $(row).data('id');
                if (id > 0) {
                    window.location.href = '/Admin/Activity/delete/id/' + id;
                }
            });
            qiniuupdate();
